...
class KVCacheManager
{
  public:
    ...
    size_t estimate_append_new_blocks(int32_t core_seq_id, bool kv_started, int32_t num_computed_tokens) const;

    size_t estimate_prefill_new_blocks(int32_t core_seq_id, bool kv_started, int32_t prompt_tokens,
                                       int32_t num_computed_tokens, int32_t prefill_tokens) const;

    void refresh_block_tables(int32_t core_seq_id, bool kv_started,
                              std::vector<std::vector<int32_t>> &block_tables) const;

    bool allocate_slots(int32_t core_seq_id, bool kv_started, int32_t num_computed_tokens,
