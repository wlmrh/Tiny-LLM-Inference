...
class LlamaModel : public torch::nn::Module
{
  ...
  private:
    void validate_forward_inputs(const Tensor &input_ids, const Tensor &positions) const;
...
class LlamaForCausalLM : public Model
{
  public:
    ...
    int32_t expected_bos_id() const override
    {
        return config_.bos_token_id;
    }
    int32_t expected_eos_id() const override
    {
        return config_.eos_token_id;
    }
    int32_t expected_unk_id() const override
    {
