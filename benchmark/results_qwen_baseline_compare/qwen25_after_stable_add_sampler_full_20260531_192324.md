# Industrial Benchmark Report: qwen25_after_stable_add_sampler_full

- generated_at: `2026-06-13T22:36:22+08:00`
- model: `/models/Qwen2.5-1.5B-Instruct`
- device: `cuda:0`
- gpu: `NVIDIA GeForce RTX 5090`, memory `32607 MiB`
- warmup/repeat: `1/3`
- profile_detail: `off`
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| interactive | tinyllm | 1 | 128 | 128 | 64 | 64.000 | 21.875 | 457.434 | 6.552 | 139.911 | 144.642 |
| interactive | transformers | 1 | 128 | 128 | 64 | 64.000 | 21.418 | 949.611 | 14.733 | 67.396 | 67.874 |
| interactive | omitted: vllm | 1 | 128 | 128 | 64 | - | - | - | - | - | - |
| chat_serving | tinyllm | 8 | 128 | 1024 | 128 | 1024.000 | 68.113 | 1520.862 | 1.293 | 673.302 | 699.364 |
| chat_serving | transformers | 8 | 128 | 1024 | 128 | 1024.000 | 60.648 | 1926.638 | 1.837 | 531.496 | 544.483 |
| chat_serving | omitted: vllm | 8 | 128 | 1024 | 128 | - | - | - | - | - | - |
| long_prefill | tinyllm | 4 | 1024 | 4096 | 64 | 256.000 | 289.671 | 1673.437 | 5.130 | 152.979 | 182.112 |
| long_prefill | transformers | 4 | 1024 | 4096 | 64 | 256.000 | 268.124 | 1215.402 | 3.759 | 210.630 | 266.025 |
| long_prefill | omitted: vllm | 4 | 1024 | 4096 | 64 | - | - | - | - | - | - |
| decode_heavy | tinyllm | 4 | 256 | 1024 | 256 | 1024.000 | 69.535 | 3206.501 | 2.840 | 319.351 | 325.155 |
| decode_heavy | transformers | 4 | 256 | 1024 | 256 | 1024.000 | 61.552 | 3816.267 | 3.681 | 268.325 | 271.658 |
| decode_heavy | omitted: vllm | 4 | 256 | 1024 | 256 | - | - | - | - | - | - |
| throughput | tinyllm | 16 | 128 | 2048 | 128 | 2048.000 | 126.212 | 2063.388 | 0.834 | 992.543 | 1048.950 |
| throughput | transformers | 16 | 128 | 2048 | 128 | 2048.000 | 119.599 | 1993.302 | 0.922 | 1027.441 | 1084.483 |
| throughput | omitted: vllm | 16 | 128 | 2048 | 128 | - | - | - | - | - | - |

## Backend Ratios

| scenario | ratio | latency | TTFT | e2e throughput | decode throughput | load/init |
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| interactive | TinyLLM / Transformers | 0.482 | 1.021 | 2.076 | 2.131 | 1.056 |
| chat_serving | TinyLLM / Transformers | 0.789 | 1.123 | 1.267 | 1.284 | 0.929 |
| long_prefill | TinyLLM / Transformers | 1.377 | 1.080 | 0.726 | 0.685 | 1.004 |
| decode_heavy | TinyLLM / Transformers | 0.840 | 1.130 | 1.190 | 1.197 | 0.950 |
| throughput | TinyLLM / Transformers | 1.035 | 1.055 | 0.966 | 0.967 | 1.055 |
